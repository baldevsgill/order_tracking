            ...
            children = List(
              ...
              new Button {
                ...
                onAction = handle {
                  ...
                  println("userTextField.text.toString() = " + userTextField.text.toString())
                  println("passwordTextField.text.toString() = " + passwordTextField.text.toString())

                  if (validateUser(userTextField.text.value.toString(), passwordTextField.text.value.toString())) {
                    val dno2 = new DisplayNewOrders2
                    //stage.hide()
